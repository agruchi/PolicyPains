                  ...
                  <div class="login-form" align="center" style="margin:0px 0px 10px;">
                     <div id="login-bg" align="center" >
                        <div class="login-inner">
                           <form id="loginForm" name="loginForm" action="authenticate" method="post">
                              <div>
                                 <input id="usernameField" class="user-input" type="text" autocomplete="off" name="j_username" maxlength="50" value="" placeholder="USERNAME" />
                              </div>
                              <div>
                                 <input id="passwordField" class="password-input" type="password" autocomplete="off" name="j_password" maxlength="50" placeholder="PASSWORD" />
                              </div>
                              <div align="center">
